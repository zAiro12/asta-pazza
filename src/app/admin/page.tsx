...
type GameEvent = { id: number; name: string; type: string; description: string; effect: object };
type Game = { id: number; code: string; status: string; createdAt: string; finishedAt: string | null; playerCount?: number; totalTurns: number; currentTurn: number };
type WhitelistEntry = { id: number; email: string };
type GameSettings = { auctionTimerSeconds: number; startingCredits: number; scugnizzuCredits: number; scugnizzuPenalty: number; miniCollectionPoints: number; fullCollectionPoints: number; majorityPoints: number; creditsResidualMax: number; commonObjectivesCount: number; rareObjectivesCount: number };
...
function Textarea({ label, ...props }: { label: string } & React.TextareaHTMLAttributes<HTMLTextAreaElement>) {
  return (
    <div>
      <label className="block text-sm fo